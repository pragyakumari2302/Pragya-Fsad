...
patchFile('FSAD_PROJECT/src/pages/Exam.jsx',
...
`<button onClick={() => {
          ...
          element.innerHTML = '<h1>Exam Guidelines</h1><ul><li>Arrive 15 mins early</li><li>Bring ID card</li><li>No electronic devices</li></ul>';
